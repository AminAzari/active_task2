...
int main (int argc, const char* argv[] )
{
 ...
 int dada = strtol((const char*)buf, NULL, 10);
  

std::ofstream outfile;
 if (from==2)
     	outfile.open("n2.txt", std::ios_base::app); 
 else if (from==1)
     	outfile.open("n1.txt", std::ios_base::app); 
 else
 	outfile.open("nx.txt", std::ios_base::app); 
 ...
 if (from==2)
     	outfile.open("n2r.txt", std::ios_base::app); 
 else if (from==1)
     	outfile.open("n1r.txt", std::ios_base::app); 
 else
 	outfile.open("nxr.txt", std::ios_base::app); 
  int irssi;
 irssi = (int) rssi ;
  outfile << irssi << endl ;
 outfile.close();
